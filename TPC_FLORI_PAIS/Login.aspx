<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TPC_FLORI_PAIS.WebForm1" %>
<!DOCTYPE html>
...
<body>
    ...
    <form action="/examples/actions/confirmation.php" method="post">
        ...
        <div class="form-group">
            <input type="password" class="form-control" placeholder="Contaseña" required="required">
        </div>
        <div class="form-group">
