<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Colores_Det.aspx.cs" Inherits="TPC_FLORI_PAIS.ABM.Colores.Colores_Det" %>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Modificar Color</strong></li>
            </ol>
        </div>
    </div>
