<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Talles_New.aspx.cs" Inherits="TPC_FLORI_PAIS.ABM.Talles.Talles_New" %>
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Agregar Talle</strong></li>
            </ol>
        </div>
    </div>
