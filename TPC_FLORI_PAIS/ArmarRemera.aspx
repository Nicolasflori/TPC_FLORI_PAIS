...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div>
        <tr>
            <td>
                <asp:Image ID="Imagenfondo" runat="server" Style="max-width: 50%; max-height: 50%" alt="Card image" />
                <asp:Image ID="Imageestampado" runat="server" Style="max-width: 50%; max-height: 50%" alt="Card image" /></td>
            <td>
