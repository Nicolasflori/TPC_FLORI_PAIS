...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server" >
    ...
    <asp:Image ID="Imageestampado" runat="server" Style="max-width: 50%; max-height: 50%; position: fixed; right: 0; bottom: 380px; left: 730px" alt="Card image" />
        <table class="table mb-2">
            ...
            <tbody>
                <tr>  
                    <td><asp:DropDownList ID="ddListaColores" runat="server" OnSelectedIndexChanged="ddListaColores_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList> </td> 
                    <td><asp:DropDownList ID="ddListaEstampados" runat="server" OnSelectedIndexChanged="ddListaEstampados_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList></td>
                    <td><asp:DropDownList ID="ddListaTalles" runat="server"></asp:DropDownList></td>
                    <td><asp:TextBox TextMode="Number" ID="TextBox1" runat="server" min="1" MaxLength="20" placeholder="1" Text="1"></asp:TextBox></td>
                </tr>
            </tbody>
        </table>
